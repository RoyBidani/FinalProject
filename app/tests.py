...
class TestMyFlaskApp(unittest.TestCase):
    ...
    def test_crud_funs(self):
        ...
        self.assertEqual(response.status_code, 302)  # Assuming successful update redirects to another page

        response = requests.post(self.base_url + delete_url)
        self.assertEqual(response.status_code, 302)  # Assuming successful delete redirects to another page
